...
import com.whenwhat.framework.other.replaceOn
...
abstract class RecyclerAdapter<ITEM>(items: List<ITEM> = emptyList()) : RecyclerView.Adapter<DefaultViewHolder>() {
    ...
    private val diffListCallback =
        DiffListCallback(::compareItems, ::compareContents)
    ...
    final override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DefaultViewHolder {
        ...
        return DefaultViewHolder(
            binders[viewType]?.createView(inflater!!)
    ...
    private fun createInflater(parent: ViewGroup) = object :
        Inflater {
